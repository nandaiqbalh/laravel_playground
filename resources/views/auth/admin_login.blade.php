...
<head>
  <meta charset="utf-8">
    ...
    <title>SiapSediaAdmin - Log in </title>
					...
					<div class="col-lg-4 col-md-5 col-12">
						...
						<div class="p-30 rounded30 box-shadowed b-2 b-dashed">
								  ...
								  <div class="row">
									...
									<div class="col-6">
									 <div class="fog-pwd text-right">
										<a href="javascript:void(0)" class="text-white hover-info"><i class="ion ion-locked"></i> Forgot password?</a><br>
									  </div>
									</div>
									<!-- /.col -->
							...
							<div class="text-center">
								<p class="mt-15 mb-0 text-white">Don't have an account? <a href="auth_register.html" class="text-info ml-5"> <b>Sign Up</b> </a></p>
							</div>
						</div>
					</div>
				</div>
